// from https://www.jasondavies.com/coffee-wheel/ - D3@3 based
...
! function () {
    ...
    d3.json("./data/sunburst.json", function (r, i) {
        ...
        h.enter().append("path").attr("id", function (t, n) {
            return "path-" + n
        }).attr("d", x).attr("fill-rule", "evenodd").style("fill", colorize).on("click", l);

        var m = f.selectAll("text").data(o),
            y = m.enter().append("text").style("fill-opacity", 1).style("fill", function (t) {
                return a(d3.rgb(colorize(t))) < 125 ? "#eee" : "#000"
